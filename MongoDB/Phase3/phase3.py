...
def call_api(screen_name, videoname, lable_output):
...
if __name__ == '__main__':
    ...
    screen_names = ['katyperry','NBA','ManUtd','justinbieber','taylorswift13','ladygaga','TheEllenShow',
                    'Cristiano','YouTube','jtimberlake','KimKardashian','britneyspears','ArianaGrande',
                    'ddlovato','selenagomez','cnnbrk','shakira','jimmyfallon','BillGates']
    for screen_name in screen_names:
	       call_api(screen_name, screen_name, screen_name)
